            ...
            <div class="ibox-content">
                <form action="{{route('customers.update',$customer->id)}}" method="post">
                    ...
                    <div class="form-group row @error('rgie') has-error @enderror">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                <input type="text" value="{{ $customer->rgie ?? '' }}" class="form-control" id="rgie" class="form-control" name="rgie" value="{{ old('rgie') ?? '' }}">
                            </div>
                            <span class="text-block text-danger" id="message"></span>
                            @error('rgie')
                            <span class="form-text m-b-none">{{$errors->first('cnpj')}}</span>
                    ...
                    <div class="form-group row @error('razao_social') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->razao_social ?? '' }}" placeholder="" id="razao_social" class="form-control" name="razao_social" value="{{ old('razao_social') ?? '' }}">
                            @error('razao_social')
                    ...
                    <div class="form-group row @error('nome_fantasia') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->nome_fantasia ?? '' }}" placeholder="" id="nome_fantasia" class="form-control" name="nome_fantasia" value="{{ old('nome_fantasia') ?? '' }}">
                            @error('nome_fantasia')
                    ...
                    <div class="form-group row @error('tipo_cadastro') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->tipo_cadastro ?? '' }}" placeholder="" id="tipo_cadastro" class="form-control" name="tipo_cadastro" value="{{ old('tipo_cadastro') ?? '' }}">
                            @error('tipo_cadastro')
                    ...
                    <div class="form-group row @error('contato') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->contato ?? '' }}" placeholder="" id="contato" class="form-control" name="contato" value="{{ old('contato') ?? '' }}">
                            @error('contato')
                    ...
                    <div class="form-group row @error('telefone') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->telefone ?? '' }}" placeholder="" id="telefone" class="form-control" name="telefone" value="{{ old('telefone') ?? '' }}">
                            @error('telefone')
                    ...
                    <div class="form-group row @error('email') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->email ?? '' }}" placeholder="" id="email" class="form-control" name="email" value="{{ old('email') ?? '' }}">
                            @error('email')
                    ...
                    <div class="form-group row @error('cep') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->cep ?? '' }}" placeholder="" id="cep" class="form-control" name="cep" value="{{ old('cep') ?? '' }}">
                            @error('cep')
                    ...
                    <div class="form-group row @error('logradouro') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->logradouro ?? '' }}" placeholder="" id="logradouro" class="form-control" name="logradouro" value="{{ old('logradouro') ?? '' }}">
                            @error('logradouro')
                    ...
                    <div class="form-group row @error('numero') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->numero ?? '' }}" placeholder="" id="numero" class="form-control" name="numero" value="{{ old('numero') ?? '' }}">
                            @error('numero')
                    ...
                    <div class="form-group row @error('bairro') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->bairro ?? '' }}" placeholder="" id="bairro" class="form-control" name="bairro" value="{{ old('bairro') ?? '' }}">
                            @error('bairro')
                    ...
                    <div class="form-group row @error('cidade') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->cidade ?? '' }}" placeholder="" id="cidade" class="form-control" name="cidade" value="{{ old('cidade') ?? '' }}">
                            @error('cidade')
                    ...
                    <div class="form-group row @error('uf') has-error @enderror">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{ $customer->uf ?? '' }}" placeholder="" id="uf" class="form-control" name="uf" value="{{ old('uf') ?? '' }}">
                            @error('uf')
